...
void setup() 
{
  ...
  valor1[3]=10;
  valor2=0;
  //myRTC.setDS1302Time(00, 00, 01, 1, 01, 01, 2017); //segundo, minuto, hora, dia da semana, dia, mes, ano
}
void loop() 
{
  myRTC.updateTime();
...
//-------------------------------------------------------------------------------------------
  /*if ((DSLIG==true) && (myRTC.hours>=horadesliga))
    {
      delay(5000);
      if ((DSLIG==true) && (myRTC.hours>=horadesliga))
      {
...
//------------------------------------------------------------------------------------------- 
  if ((ACLIG==true) && (myRTC.hours>=horadesliga))
    {
      delay(5000);
      if ((ACLIG==true) && (myRTC.hours>=horadesliga))
      {
