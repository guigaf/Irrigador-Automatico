...
void setup() 
{
  ...
  //myRTC.setDS1302Time(00, 00, 16, 6, 11, 9, 2017); //segundo, minuto, hora, dia da semana, dia, mes, ano
  //delay(1000);
  serial1.begin(38400);
  Serial.begin(38400);
  valor1[0]=0;
...
//-------------------------------------------------------------------------------------------
        if (auxtimeoff22>=3)
        {
          ...
          myRTC.setDS1302Time(secatu, minatu, horaatu, diasemanaatu, diaatu, mesatu, anoatu); //segundo, minuto, hora, dia da semana, dia, mes, ano
...
//-------------------------------------------------------------------------------------------
  if ((auxdesliga1==true)/* && (auxdesliga2==true)*/)
    {
